...
export function StitchShell({ active = 'home', children }: Props) {
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen pb-24">
      <header className="fixed top-0 w-full h-16 z-50 bg-white border-b flex justify-between items-center px-4">
      ...
      <footer className="bg-pink-50/50 border-t mt-12 py-10 px-4 text-center text-sm text-gray-500">
        <p>西船橋メンズエステ　ティアラ</p>
        <a href="tel:05017438883" className="text-pink-600 font-bold text-lg mt-2 inline-block">
          050-1743-8883
        </a>
        <p className="text-[10px] mt-6">© 2026 ティアラ. All rights reserved.</p>
      </footer>

      <nav className="fixed bottom-0 w-full z-50 border-t bg-white px-2 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
        <div className="flex justify-around max-w-lg mx-auto">
          ...
          <a
            ...
            aria-label="電話"
          >
            <span className="bg-pink-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg">
          ...
          <Link href="/#schedule" className="flex flex-col items-center py-1.5 min-w-[52px] text-gray-500">
